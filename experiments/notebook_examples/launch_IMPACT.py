...
if __name__ == '__main__':
    ...
    config = generate_eval_config(esc = 'error', valid_metric= 'rmse', pred_metrics = ['rmse', 'mae'], profile_metrics = ['doa', 'pc-er', 'rm'], save_params=False, seed=args.seed, i_fold=args.i_fold)
