...
class IMPACT(AbstractContinuousModel):
    ...
    def _compute_loss(self, users_id, items_id, concepts_id, labels):
        ...
        L1, L2, L3 = custom_loss(u_emb=u_emb, im_emb_prime=im_emb_prime, i0_emb_prime=i0_emb_prime,
        ...
        R = self.model.users_emb.weight.norm().pow(2) + self.model.item_response_embeddings.weight.norm().pow(
            2) + self.model.W.data.norm().pow(2)
